...
minish: minish.o wrappers.o linea2argv.o exit.o getenv.o setenv.o help.o pid.o uid.o status.o unsetenv.o ejecutar.o externo.o cd.o auxiliar_functions.o gid.o
